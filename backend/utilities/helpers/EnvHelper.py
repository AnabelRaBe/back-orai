...
class EnvHelper:
    def __init__(self, **kwargs) -> None:
        ...
        self.AZURE_INGEST_INDEX = os.getenv('AZURE_INGEST_INDEX', '')
        ...
        self.AZURE_BLOB_GLOBAL_DOCUMENTS_CONTAINER_NAME = os.getenv('AZURE_BLOB_GLOBAL_DOCUMENTS_CONTAINER_NAME', '')
        self.AZURE_BLOB_LOCAL_DOCUMENTS_CONTAINER_NAME = os.getenv('AZURE_BLOB_LOCAL_DOCUMENTS_CONTAINER_NAME', '')
        self.AZURE_BLOB_CONTAINER_CONVERSATIONS_NAME = os.getenv('AZURE_BLOB_CONTAINER_CONVERSATIONS_NAME', '')
        self.AZURE_BLOB_CONTAINER_FEEDBACK_NAME = os.getenv('AZURE_BLOB_CONTAINER_FEEDBACK_NAME', '')
