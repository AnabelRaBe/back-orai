...
class TestReadDocumentLoading(unittest.TestCase):
    def setUp(self):
        self.loader = ReadDocumentLoading()

    @patch('backend.utilities.document_loading.Read.AzureFormRecognizerClient')
    def test_load(self, mockazureformrecognizerclient):
        ...
        mock_instance.begin_analyze_document_from_url.assert_called_once_with(document_url, use_layout=False)
